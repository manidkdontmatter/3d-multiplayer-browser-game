...
export const WORLD_GROUND_HALF_EXTENT = 128;
export const WORLD_GROUND_HALF_THICKNESS = 0.5;
...
export const PLAYER_FLY_SPEED = 50;
export const PLAYER_FLY_SPRINT_SPEED = 70;
export const PLAYER_FLY_ACCEL = 200;
...
export const MODEL_ID_NPC_HOSTILE_GUARD = 6;
export const MODEL_ID_NPC_DOCILE_FLEE = 7;
export const MODEL_ID_NPC_WANDERER = 8;
export const MODEL_ID_LOCATION_TERRAIN_ISLAND = 20;
export const MODEL_ID_LOCATION_STATIC_CASTLE = 21;
export const MODEL_ID_LOCATION_MOVING_CASTLE = 22;
export const MODEL_ID_LOCATION_TEST_ARENA = 23;
export const MODEL_ID_LOCATION_MOVING_TEST_PLATFORM = 24;
export const MODEL_ID_ITEM_VITALITY_SHARD = 40;
export const MODEL_ID_ITEM_FOCUS_BLADE = 41;
export const MODEL_ID_ITEM_ETHER_CRYSTAL = 42;
