...
export const PHYSICS_LAYER_CARRIER_SENSOR = 1 << 2;
...
export const PHYSICS_GROUP_CHARACTER = interactionGroups(
  ...
  PHYSICS_LAYER_SOLID | PHYSICS_LAYER_CHARACTER | PHYSICS_LAYER_CARRIER_SENSOR
);

export const PHYSICS_GROUP_CARRIER_SENSOR = interactionGroups(
  PHYSICS_LAYER_CARRIER_SENSOR,
  PHYSICS_LAYER_DYNAMIC_BODY | PHYSICS_LAYER_CHARACTER
);

export const PHYSICS_GROUP_DYNAMIC_BODY = interactionGroups(
  PHYSICS_LAYER_DYNAMIC_BODY,
  PHYSICS_LAYER_SOLID | PHYSICS_LAYER_CARRIER_SENSOR | PHYSICS_LAYER_DYNAMIC_BODY
);
