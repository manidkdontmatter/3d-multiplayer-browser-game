...
export type WorldWithComponents = {
  components: {
    ...
    ProjectileOwnerEid: { value: number[] };
    ...
    ProjectileInitialTtl: { value: number[] };
    ...
    ProjectilePatternSeed: { value: number[] };
    ProjectilePatternKind: { value: number[] };
    ProjectilePatternSpiralFrequencyHz: { value: number[] };
    ProjectilePatternSpiralStrength: { value: number[] };
    ProjectileBaseDirection: { x: number[]; y: number[]; z: number[] };
    ProjectileTargetAllowSelf: { value: number[] };
    ProjectileTargetAllowPlayers: { value: number[] };
    ProjectileTargetAllowNpcs: { value: number[] };
